...
void body_to_world(float input[3], float output[3], struct quaternion q){
    // Compute the rotation matrix from the quaternion
    float R[3][3] = {
        {1 - 2*q.q3*q.q3 - 2*q.q4*q.q4, 2*q.q2*q.q3 - 2*q.q1*q.q4, 2*q.q2*q.q4 + 2*q.q1*q.q3},
        {2*q.q2*q.q3 + 2*q.q1*q.q4, 1 - 2*q.q2*q.q2 - 2*q.q4*q.q4, 2*q.q3*q.q4 - 2*q.q1*q.q2},
        {2*q.q2*q.q4 - 2*q.q1*q.q3, 2*q.q3*q.q4 + 2*q.q1*q.q2, 1 - 2*q.q2*q.q2 - 2*q.q3*q.q3}
    };
    
    // Multiply the body vector by the rotation matrix to get the world vector
    output[0] = R[0][0]*input[0] + R[0][1]*input[1] + R[0][2]*input[2];
    output[1] = R[1][0]*input[0] + R[1][1]*input[1] + R[1][2]*input[2];
    output[2] = R[2][0]*input[0] + R[2][1]*input[1] + R[2][2]*input[2];
}